...
(0, _cucumber.When)(/^I (check)?(uncheck)? "([^"]*)" (?:checkbox|radio button)$/, /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            console.log("I ".concat(unchecked ? "uncheck" : "check", " ").concat(elementKey, " checkbox|radio button"));
