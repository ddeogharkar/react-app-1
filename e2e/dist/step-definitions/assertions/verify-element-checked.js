...
(0, _cucumber.Then)(/^the "([^"]*)" (?:checkbox|radio button) should( not)? be checked$/, /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            console.log("the ".concat(elementKey, " checkbox|radio button should ").concat(negate ? "not" : "", " be checked"));
