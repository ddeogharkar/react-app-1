Feature: As a user I can interact with iframes
  ...
  Scenario: As a user I can interact and assert on iframes
    ...
    Then I fill in the "search" input on the "basic iframe" iframe with "Abraham Perry"
    And the "contact" on the "basic iframe" iframe should be displayed
    Then the "full name label" on the "basic iframe" iframe should contain the text "Name:"
    ...
    And the "address" on the "basic iframe" iframe should contain the text "Ap #826-8849 Vulputate Street, Laramie"
